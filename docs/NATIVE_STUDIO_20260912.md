...
**실제 APK 생성 완료:** [Actions34702041819](https://github.com/wooyeonho/yeno-os/actions/runs/34702041819), 소스 `94f6258695e5e914ff36037246548f2e1934db93`,59,455,729바이트. SHA-256 `d41b31814cb5862ded83af0fed311f5d36c7dbcdffa00901185af6a402b55a55`. ZIP/내부 APK 해시·패키지·버전·서명을 확인했다. **기존 APK와 서명이 달라 기존 설치 위 업데이트는 미완료이며, 기존 앱을 삭제하지 않는다.** 새 설치용 파일과 실제 휴대폰 사용 검증을 구분한다.
...
원래 전달한 APK SHA-256 `38de18459ef84735ef2d0c36f890cc3f4bb188d57d7b77eec6f369eb7d47ddd6`를 재확인하고 공개 서명 인증서 SHA-256 `6a9df77d9729f0b538fae81928fa32cc1eb70766cc36ad8ce039d73d8374ab00`을 추출했다. 새 APK 인증서 `91bf7eadd8baf1604fa469d70a2785b86963390337afa3c5312c3f0e638b8046`과 **불일치**함을 확인했다. **기존 앱의 서명 키는 이 작업 공간에 제공되지 않았다. 서명이 다른 APK를 설치하려고 기존 앱을 삭제하지 않는다.** 기존 연결과 접수 대기 기록을 유지해야 한다. 지속적인 앱 업데이트에는 소유자 관리 서명 키가 필요하다.

GitHub 검사에서는293개 중286개 통과/실패0/영상 구성 미비7개 생략, 빌드된 UI 검사 통과(영상 렌더러 미구성)였다. 위 로컬293/293 실제 영상 필수 검사와 구분한다. [통합 증거](NATIVE_UI_VERIFICATION_20260912.json), [실제 컴파일한 Cargo.lock](builds/android-94f62586-Cargo.lock)을 보존했다. CI의 lock 재생성 절차는 기존대로이며 소스의 오래된 lock을 이번 빌드의 동결 입력으로 표시하지 않는다.
