...
function fixture(t) {
  ...
  const project = { id: crypto.randomUUID(), name: 'YENO', repositoryUrl: 'https://github.com/wooyeonho/yeno-os', summary: '개인 운영체제', nextAction: '복구 검증', status: 'active', version: 1, createdAt: at, updatedAt: at };
