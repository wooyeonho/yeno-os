...
export function productionCapabilities(state,{videoAvailable=false,providerReady=false}={}){
  ...
  return {capabilities:[
    ...
    {...capability('research','문제의 답 · EUREKA',providerReady?'available':'connection_required','공개 논문 초록·서지정보 최대4건을 수집하고 근거·잠정 답·다음 검증을 보관합니다. 기존 E01~E09 연구 트랙을 사용합니다.'),completedOutputs:state.jobs.filter(job=>job.researchRequest&&job.status==='completed').length},
