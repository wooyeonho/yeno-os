...
export const FORAI_RESERVED_ARTIFACT_BYTES = 256 * 1024;
...
function estimate(state, reservation) {
  ...
  return {
    ...
    pendingVideoCount, pendingForAiCount, pendingResearchCount, pendingWorldCount, pendingArchiveBytes, additionalArchiveBytes,
